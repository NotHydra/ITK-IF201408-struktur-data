namespace AdvanceSorting
{
    public class CommandLineInterface()
    {
        ...
        {
            Structure.LinkedList<int> linkedList1 = new();
            linkedList1.AddRandom(5, 0, 100);
            containers.Add(linkedList1);

            Structure.LinkedList<int> linkedList2 = new();
            linkedList2.AddRandom(10, 0, 100);
            containers.Add(linkedList2);
